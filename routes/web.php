...
Route::middleware('setLanguage')->group(function () {
    ...
    Route::get('/find-doctors', [FrontController::class, 'medicalDoctors'])->name('medicalDoctors');
    Route::get('find-doctors/{doctor}', [FrontController::class, 'detailDoctor'])->name('detailDoctor');
    Route::get('find-clinics/{user}', [FrontController::class, 'detailClinic'])->name('detailClinic');
   Route::get('/search', [FrontController::class, 'searchDoctors'])->name('front.searchDoctors');
});
//Change language
...
Route::prefix('admin')->middleware('auth', 'xss', 'checkUserStatus', 'checkImpersonateUser')->group(function () {
    ...
    // Clinic route
    Route::middleware('permission:manage_clinic')->group(function () {
