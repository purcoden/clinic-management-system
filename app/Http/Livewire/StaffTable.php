...
class StaffTable extends LivewireTableComponent
{
    ...
    {
        return [
            Column::make(__('Clinic Name'), 'first_name')->view('staffs.components.staff_name')
                ->sortable()->searchable(
            ...
            Column::make(__('No. Izin'), 'no_izin')->view('staffs.components.no_izin'),
            Column::make(__('Phone Number'), 'contact')->view('staffs.components.phone'),
