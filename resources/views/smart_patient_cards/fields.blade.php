<div class="card main-div d-flex flex-row">
    <div class="col-6 p-5">
        <div class="row col-8">
            <div class="mb-5">
    ...
    <div class="col-6 bg-secondary p-5">
                            ...
                            <div class="d-flex mb-3">
                                ...
                                <div class="">
                                    <table class="table table-borderless patient-desc mb-0">
                                        ...
                                        <tr id="card_show_email" class=" @if (isset($smart_patient_cards) && $smart_patient_cards->show_email != 1) d-none @endif ">
