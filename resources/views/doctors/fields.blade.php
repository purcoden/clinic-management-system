<div class="row">
    ...
    <div class="col-md-6">
        <div class="mb-5">
            ...
            {{ Form::text('first_name', null,['class' => 'form-control','placeholder' => __('Name'),'required']) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-5">
            {{ Form::label('No. STR',__('No. STR').':' ,['class' => 'form-label required']) }}
            {{ Form::text('no_str', null,['class' => 'form-control','placeholder' => __('No. STR'),'required']) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-5">
    ...
    <div class="col-md-6">
        <div class="mb-5">
            ...
            {{ Form::tel('contact', null,['class' => 'form-control','placeholder' => __('Contact Number'),'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")','id'=>'phoneNumber']) }}
    ...
    <div class="col-md-6">
        <div class="mb-5">
            ...
            {{ Form::text('dob', null,['class' => 'form-control doctor-dob','placeholder' => __('Date Of Birth'), 'id'=>'dob']) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-5">
            {{ Form::label('Experience',__('Experience').':' ,['class' => 'form-label']) }}
            {{ Form::text('experience', null,['class' => 'form-control','onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")','placeholder' => __('Experience'),'step'=>'any']) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-5">
    ...
    <div class="col-md-6 mb-5">
        {{ Form::label('Address1',__('Address').':' ,['class' => 'form-label']) }}
        {{ Form::textarea('address1', null,['class' => 'form-control', 'rows' => '3','cols' => '5', 'placeholder' => __('Address')]) }}
    </div>
    <div class="col-lg-6">
        <div class="mb-5">
