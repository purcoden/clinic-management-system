                    ...
                    <div class="container pb---70">
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6"> 
                                    <div class="react-grid react-list" style="position: relative !important;height: auto !important;">                            
                                        <div class="single-studies grid-item" style="position: relative !important";>
                                            <div class="inner-course">
                                                <div class="case-img">
                                                    <img src="{{ $doctor->user->profile_image }}" alt="doctor 1">
                                                </div>
                                                <div class="case-content descript-list doctor">
                                                    
                                                    <h4 class="case-title"> <a href="{{ route('detailDoctor', $doctor->id) }}">{{ $doctor->user->first_name }}</a></h4>
                                                @foreach($doctor['specializations'] as $val)
                                                <font style="font-size:14px;line-height:1em !important;">{{$val->name}}
                                                @if( !$loop->last)
                                                </font>,
